...
func NewWbMdm381(ctx context.Context, client mqtt.ClientInterface) *WbMdm381 {
	onceWbMdm381.Do(func() {
		...
		controlList := &WbMdm381Controls{
			...
			Input1SinglePressCounter: control.NewValueControl(ctx, client, name, "Input 1 Single Press Counter", control.Meta{
				Type: "value",
			...
			Input1LongPressCounter: control.NewValueControl(ctx, client, name, "Input 1 Long Press Counter", control.Meta{
				Type: "value",
			...
			Input2SinglePressCounter: control.NewValueControl(ctx, client, name, "Input 2 Single Press Counter", control.Meta{
				Type: "value",
			...
			Input2LongPressCounter: control.NewValueControl(ctx, client, name, "Input 2 Long Press Counter", control.Meta{
				Type: "value",
			...
			Input3SinglePressCounter: control.NewValueControl(ctx, client, name, "Input 3 Single Press Counter", control.Meta{
				Type: "value",
			...
			Input3LongPressCounter: control.NewValueControl(ctx, client, name, "Input 3 Long Press Counter", control.Meta{
				Type: "value",
			...
			Input4SinglePressCounter: control.NewValueControl(ctx, client, name, "Input 4 Single Press Counter", control.Meta{
				Type: "value",
			...
			Input4LongPressCounter: control.NewValueControl(ctx, client, name, "Input 4 Long Press Counter", control.Meta{
				Type: "value",
			...
			Input5: control.NewSwitchControl(ctx, client, name, "Input 5", control.Meta{
				Type: "switch",
			...
			Input5Counter: control.NewValueControl(ctx, client, name, "Input 5 counter", control.Meta{
				Type: "value",
			...
			Input5SinglePressCounter: control.NewValueControl(ctx, client, name, "Input 5 Single Press Counter", control.Meta{
				Type: "value",
			...
			Input5LongPressCounter: control.NewValueControl(ctx, client, name, "Input 5 Long Press Counter", control.Meta{
				Type: "value",
			...
			Input6: control.NewSwitchControl(ctx, client, name, "Input 6", control.Meta{
				Type: "switch",
			...
			Input6Counter: control.NewValueControl(ctx, client, name, "Input 6 counter", control.Meta{
				Type: "value",
			...
			Input6SinglePressCounter: control.NewValueControl(ctx, client, name, "Input 6 Single Press Counter", control.Meta{
				Type: "value",
			...
			Input6LongPressCounter: control.NewValueControl(ctx, client, name, "Input 6 Long Press Counter", control.Meta{
				Type: "value",
			...
			Channel1: control.NewRangeControl(ctx, client, name, "Channel 1", control.Meta{
				Type: "range",
			...
			Channel2: control.NewRangeControl(ctx, client, name, "Channel 2", control.Meta{
				Type: "range",
			...
			Channel3: control.NewRangeControl(ctx, client, name, "Channel 3", control.Meta{
				Type: "range",
			...
			AcOnLN: control.NewSwitchControl(ctx, client, name, "AC on L-N", control.Meta{
				Type: "switch",
